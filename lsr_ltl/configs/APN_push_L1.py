...
data_train_opt['dataset_name'] = 'action_VAE_push_v1'
...
data_test_opt['dataset_name'] = 'action_VAE_push_v1'
...
data_valid_opt = {}
data_valid_opt['path_to_data'] = './action_data/push/evaluation_push_actions.pkl'
data_valid_opt['path_to_result_file'] = './models/APN_push_evaluation_results.txt'
data_valid_opt['split'] = 'valid'
data_valid_opt['dtype'] = 'original'
data_valid_opt['img_size'] = 256

data_original_opt = {}
data_original_opt['path_to_original_dataset'] = './action_data/push/'
data_original_opt['original_dataset_name'] = 'push_actions'
data_original_opt['path_to_original_train_data'] = './action_data/push/train_push_actions.pkl'
data_original_opt['path_to_original_test_data'] = './action_data/push/test_push_actions.pkl'
