...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul  3 09:30:54 2020

@author: petrapoklukar

Functions for training a AE with the additional action loss.
...
# ====================== Training functions ====================== #
# ---
class AE_Algorithm_extension_dev():
...
# #        import torch.utils.data as data
# #        valid_sampler = data.SubsetRandomSampler(
# #            np.random.choice(list(range(len(valid_dataset))),
# #                             2*self.batch_size, replace=False))
...
#                             5*self.batch_size, replace=False))
#        TODO: shuffle, sampler
        ...
        for self.current_epoch in range(self.start_epoch, self.epochs):
            ...
            valid_loss = np.zeros(10)#self.compute_test_loss(test_dataset)
...
if __name__ == '__main__':
    ...
    algorithm = AE_Algorithm(vae_opt)
