...
if ltl == "row":
    state = './state_dict_row_img.pt'
    num_elem = 1000


    X_pickle = pickle.load( open( "./datasets_lstm_img/X.pkl", "rb" ) )
    Y_pickle = pickle.load( open( "./datasets_lstm_img/Y.pkl", "rb" ) )
