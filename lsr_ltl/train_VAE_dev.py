...
from dataloader import TripletTensorDataset, preprocess_triplet_data

parser = argparse.ArgumentParser()
parser.add_argument('--exp_vae', type=str, required=True, default='', 
                   help='config file with parameters of the vae model')
parser.add_argument('--preprocess_data', type=int, default=0, 
                   help='preprocesses the data')
...
## --- TESTING --- #
# args_opt.exp_vae = 'TESTINGscheduling'
# args_opt.cuda = None
# args_opt.preprocess_data = 0
# args_opt.chpnt_path = '' #'models/TESTINGscheduling/vae_checkpoint1.pth'
# args_opt.num_workers = 4
## --------------- #
...
# Preprocess the data
if args_opt.preprocess_data:
    preprocess_triplet_data(vae_config['data_train_opt']['dataset_name'])
    print(' *- Generated train and test splits.'.format(vae_config['data_train_opt']['dataset_name']))
